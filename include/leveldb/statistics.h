...
namespace leveldb{
 ...
 const std::vector<std::pair<Tickers,std::string>> TickersNameMap={
     ...
     {ACCESS_L7_TIME,"leveldb.access.l7.time"},
     {ACCESS_L8_TIME,"leveldb.access.l8.time"},
     {ACCESS_L9_TIME,"leveldb.access.l9.time"},
     {ACCESS_L10_TIME,"leveldb.access.l10.time"},
     {ACCESS_L11_TIME,"leveldb.access.l11.time"},
     {ACCESS_L12_TIME,"leveldb.access.l12.time"},
