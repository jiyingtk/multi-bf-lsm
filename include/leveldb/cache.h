...
extern Cache* NewMultiQueue(size_t capacity,int lrus_num,int base_num=64,uint64_t life_time=50,double force_shrink_ratio=1.1,double quick_shrink_ratio=0.99,double slow_shrink_ratio=0.95,int lg_b=3);
class Cache {
 public:
  Cache() { }
