...
TableCache::TableCache(const std::string& dbname,
    ...
    : env_(options->env),
      dbname_(dbname),
      options_(options),
      cache_(NewMultiQueue(entries,options->opEp_.lrus_num_,options->opEp_.base_num,options->opEp_.life_time,options->opEp_.force_shrink_ratio,options->opEp_.quick_shrink_ratio,options->opEp_.slow_shrink_ratio,options->opEp_.log_base,options->opEp_.slow_ratio)) {
}
